...
def generate_qa_from_real_data():
    ...
    for i, qa in enumerate(qa_pairs, 1):
        ...
        try:
            ...
            if any(str(val) in agent_response for val in [
        ...
        for afp in ['Habitat', 'Integra', 'Prima', 'Profuturo']:
            try:
                ...
                if 'error' not in data:
                    print(f"   📈 {afp}:")
                    print(f"      - 1 año nominal: {data['rentability_data']['period_1_nominal']}%")
                    print(f"      - 1 año real: {data['rentability_data']['period_1_real']}%")
                    if 'period_9_nominal' in data['rentability_data']:
                        print(f"      - 9 años nominal: {data['rentability_data']['period_9_nominal']}%")
                        print(f"      - 9 años real: {data['rentability_data']['period_9_real']}%")
                else:
